        ...
        <Row>
          <Col md={12} lg={7} className="mb-5 mt-5 p-4 featureLeft">
            ...
            <p className="font-xxl mb-0 brown-color headingTxt mt-3 font-semi-bold">
              Myyy Dragons are part of the Dripped Out Dragons Universe, or DragonVerse. Myyy Dragons are a collection of 10k baby dragons that live on Polygon.
            </p>
            ...
            <p className="fontSize20 brown-color mt-2">
              The goal of DragonVerse is to generate a passive income for all coin($Drip) and NfT holders through buying/selling of said assets, and real world stuffed animals, tv shows, movies, or licensing.              
            </p>
            <a
